classdef Test_func_Booking < matlab.uitest.TestCase
    properties
        QueryUI1;
        QueryUI2;
        QueryUI3;
    ...
    methods(Test)
        %t3.4
        function test_multiuser_book(testcase)
            testcase.UserBackend1 = user_backend('张三',testcase.traindb,testcase.t);
            testcase.QueryUI1 = testcase.UserBackend1.QueryUI;
            testcase.UserBackend2 = user_backend('李四',testcase.traindb,testcase.t);
            testcase.QueryUI2 = testcase.UserBackend2.QueryUI;
            testcase.UserBackend3 = user_backend('王五',testcase.traindb,testcase.t);
            testcase.QueryUI3 = testcase.UserBackend3.QueryUI;    
            pause(15);
            %t3.4.1
            testcase.choose(testcase.QueryUI1.DropDown_3,'上海');
            testcase.choose(testcase.QueryUI1.DropDown_4,'苏州');
            pause(2);
            testcase.press(testcase.QueryUI1.Button_4);
            pause(1);
            testcase.press(testcase.UserBackend1.TrainUI.buttons(1));
            pause(1);
            testcase.choose(testcase.QueryUI2.DropDown_3,'上海');
            testcase.choose(testcase.QueryUI2.DropDown_4,'苏州');
            testcase.press(testcase.QueryUI2.Button_4);
            pause(1);
            testcase.press(testcase.UserBackend2.TrainUI.buttons(1)); 
            pause(1);
            testcase.choose(testcase.QueryUI3.DropDown_3,'上海');
            pause(1);
            testcase.choose(testcase.QueryUI3.DropDown_4,'苏州');
            pause(1);
            testcase.press(testcase.QueryUI3.Button_4);
            pause(1);
            testcase.press(testcase.UserBackend3.TrainUI.buttons(1));            
        end
        function test_overtime_book(testcase)
            testcase.UserBackend1 = user_backend('张三',testcase.traindb,testcase.t);
            pause(1);
            testcase.QueryUI1 = testcase.UserBackend1.QueryUI;
            pause(3);
            ...
            testcase.press(testcase.UserBackend1.TrainUI.buttons(1));
            pause(1);
            testcase.choose(testcase.UserBackend1.Time_backend.UI.DropDown,'20秒/1秒');
