classdef TestQueryUI < matlab.uitest.TestCase
    properties
        QueryUI;
        UserBackend;
    end
    ...
    methods(Test)
        %t1.5.1
        function test_Button_4Pushed(testcase)
            % T1.5.1.1
            testcase.QueryUI.DropDown_3.Value = '上海';
            testcase.QueryUI.DropDown_4.Value = '杭州';
            ...
            testcase.QueryUI = testcase.UserBackend.QueryUI;            
            testcase.QueryUI.DropDown_3.Value = '上海';
            testcase.QueryUI.DropDown_4.Value = '上海';
            testcase.press(testcase.QueryUI.Button_4);
        end
        %t1.5.2.1
        function test_find_train(testcase)
            testcase.QueryUI.find_train('上海','杭州');
        end
        %t1.5.2.2
        function test_find_train1(testcase)
            testcase.UserBackend.Time_backend.Clock = datetime('16:00','InputFormat','HH:mm');
            testcase.QueryUI.find_train('上海','杭州');
        end
        %t1.5.3.1
        function test_find_train_except(testcase)
            train10 = train("D12",1,"上海虹桥","杭州东","10:03","11:00",{'上海虹桥','','10:03',2;'嘉兴南','10:30','10:33',2;'杭州东','11:00','',0});
            single_plan1 = {"D12", '无', '10:03', '11:00', '2', '2', 0, train10, 1, 3};            
            testcase.QueryUI.find_train_except('上海','杭州',single_plan1);
        end
        %t1.5.3.2
        function test_find_train_except1(testcase)
            testcase.UserBackend.Time_backend.Clock = datetime('16:00','InputFormat','HH:mm');
            train10 = train("D12",1,"上海虹桥","杭州东","10:03","11:00",{'上海虹桥','','10:03',2;'嘉兴南','10:30','10:33',2;'杭州东','11:00','',0});
            single_plan1 = {"D12", '无', '10:03', '11:00', '2', '2', 0, train10, 1, 3};
            testcase.QueryUI.find_train_except('上海','杭州',single_plan1);
