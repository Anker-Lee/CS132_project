classdef Test_function < matlab.uitest.TestCase
    ...
    methods (Test)
        function test_human(testCase)
            ...
            testCase.verifyEqual(ret, 1)
            pause(5)
            delete(testCase.inUI_1);
            delete(testCase.inUI_2);
            delete(testCase.outUI_1);
            delete(testCase.outUI_2);
            delete(testCase.outUI_3);
            delete(testCase.Back);
        end
