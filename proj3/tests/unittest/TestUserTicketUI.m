classdef TestUserTicketUI < matlab.uitest.TestCase
    properties
        QueryUI;
        UserBackend;
    end
    ...
    methods(Test)
        %t1.10.1
        % T1.10.1.1
        function test_ButtonPushed(testcase)
            testcase.press(testcase.QueryUI.Button_5);  
            ...
            testcase.UserBackend.UserTicketUI.single_ticket = single_plan;
            testcase.UserBackend.UserTicketUI.single_ticket_state = true;
            testcase.press(testcase.UserBackend.UserTicketUI.Button);
        end
        %t1.10.2
        % T1.10.2.1
        function test_Button_2_1(testcase)
            testcase.press(testcase.QueryUI.Button_5);  
            train10 = train("D12",1,"上海虹桥","杭州东","10:03","11:00",{'上海虹桥','','10:03',2;'嘉兴南','10:30','10:33',2;'杭州东','11:00','',0});
            single_plan = {"D12", '无', '10:03', '11:00', '2', '2', 0, train10, 1, 3};  
            testcase.UserBackend.UserTicketUI.single_ticket = single_plan;
            testcase.UserBackend.UserTicketUI.single_ticket_state = true;
            testcase.press(testcase.UserBackend.UserTicketUI.Button_2);            
        end
        % T1.10.2.1
        function test_Button_2_2(testcase)
            testcase.press(testcase.QueryUI.Button_5);  
