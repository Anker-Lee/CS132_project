classdef TestTimebackend < matlab.uitest.TestCase
    properties
        App;
        backend;
    end
    ...
    methods (TestMethodSetup)
        function launchApp(testcase)
            ...
            testcase.backend = back(train_db,train_state_UI);            
        end
    end

    methods(Test)
        %t1.2.1
        function test_setspeed(testcase)
            % T1.2.1.1
            testcase.backend.UI.DropDown.Value = '10秒/1秒';
            testcase.backend.setspeed();
            testcase.verifyEqual(testcase.backend.time_period,10);
            % T1.2.1.2
            testcase.backend.UI.DropDown.Value = '20秒/1秒';
            testcase.backend.setspeed();
            testcase.verifyEqual(testcase.backend.time_period,20);
            % T1.2.1.3
            testcase.backend.UI.DropDown.Value = '5秒/1秒';
            testcase.backend.setspeed();
            testcase.verifyEqual(testcase.backend.time_period,5);
        end
    end
end