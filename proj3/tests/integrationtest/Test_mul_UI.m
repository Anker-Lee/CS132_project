classdef Test_mul_UI < matlab.uitest.TestCase
    properties
        QueryUI1;
        QueryUI2;
        QueryUI3;
    ...
    methods(Test)
        %t2.2
        function test_refund_ticket(testcase)
            ...
            testcase.press(testcase.UserBackend1.QueryUI.Button_5);
            testcase.press(testcase.UserBackend1.UserTicketUI.buttons(1));
            testcase.press(testcase.UserBackend1.UserTicketUI.Button);
        end
        function test_change_ticket(testcase)
            testcase.UserBackend1 = user_backend('张三',testcase.traindb,testcase.t);
            testcase.QueryUI1 = testcase.UserBackend1.QueryUI; 
            testcase.choose(testcase.QueryUI1.DropDown_3,'上海');
            testcase.choose(testcase.QueryUI1.DropDown_4,'杭州');
            ...
            testcase.press(testcase.UserBackend1.QueryUI.Button_5);
            testcase.press(testcase.UserBackend1.UserTicketUI.buttons(1));
            testcase.press(testcase.UserBackend1.UserTicketUI.Button_2);
            testcase.press(testcase.UserBackend1.Train_change_UI.buttons(1));
            testcase.type(testcase.UserBackend1.Time_backend.UI.EditField,11);
            testcase.type(testcase.UserBackend1.Time_backend.UI.EditField_2,30);
