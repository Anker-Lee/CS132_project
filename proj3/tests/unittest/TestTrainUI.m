classdef TestTrainUI < matlab.uitest.TestCase
    properties
        QueryUI;
        UserBackend;
    end
    ...
    methods (TestMethodSetup)
        function launchApp(testcase)
            ...
            train10 = train("D12",1,"上海虹桥","杭州东","10:03","11:00",{'上海虹桥','','10:03',0;'嘉兴南','10:30','10:33',2;'杭州东','11:00','',0});
            ...
            testcase.UserBackend = user_backend('1',train_db,time);
            testcase.QueryUI = testcase.UserBackend.QueryUI;
        end
    end
    ...
    methods(Test)
        %t1.6.1
        % T1.6.1.1
        function test_buttonCallback1(testcase)
            testcase.QueryUI.find_train('上海','杭州');
            testcase.press(testcase.UserBackend.TrainUI.buttons(1));
        end
        %t1.6.1.4
        function test_buttonCallback4(testcase)
            testcase.QueryUI.find_train('上海','杭州');
            testcase.press(testcase.UserBackend.TrainUI.buttons(2));
        end
        %t1.6.1.2
        function test_buttonCallback2(testcase)
            testcase.QueryUI.find_train('上海','杭州');
            testcase.press(testcase.UserBackend.TrainUI.buttons(2));
            testcase.press(testcase.UserBackend.OrderUI.Button)
            testcase.UserBackend.QueryUI.find_train('上海','杭州');
            testcase.press(testcase.UserBackend.TrainUI.buttons(2));
        end
        %t1.6.1.3 a little problem timeset
        function test_buttonCallback3(testcase)
            testcase.QueryUI.find_train('上海','杭州');
            testcase.UserBackend.Clock = datetime('12:00','InputFormat','HH:mm');
            testcase.press(testcase.UserBackend.TrainUI.buttons(2));
        end

        %t1.6.2
        function test_Find_num_available_ticket(testcase)
            % T1.6.2.1
            testcase.QueryUI.find_train('上海','杭州');
            train10 = train("D12",1,"上海虹桥","杭州东","10:03","11:00",{'上海虹桥','','10:03',2;'嘉兴南','10:30','10:33',2;'杭州东','11:00','',0});
            single_plan = {"D12", '无', '10:03', '11:00', '2', '2', 0, train10, 1, 3}; 
            testcase.verifyEqual(testcase.UserBackend.TrainUI.Find_num_available_ticket(single_plan),2);
            % T1.6.2.2
            train1 = train("G11",4,"上海虹桥","南京南","10:33","11:30",{'上海虹桥', '', '10:33',1; '南京南', '11:30', '',0});
            train4 = train("G24",4,"南京南","杭州东","12:33","13:30",{'南京南', '', '12:33',2; '杭州东', '13:30', '',0});
            single_plan ={"G11中转G24", '南京南', '10:33', '13:30', '2', '8', 1, train1, train4, 1, 2};
            testcase.verifyEqual(testcase.UserBackend.TrainUI.Find_num_available_ticket(single_plan),1);
            % T1.6.2.3
            train1 = train("G11",4,"上海虹桥","南京南","10:33","11:30",{'上海虹桥', '', '10:33',1; '南京南', '11:30', '',0});
            train4 = train("G24",4,"南京南","杭州东","12:33","13:30",{'南京南', '', '12:33',0; '杭州东', '13:30', '',0});
            single_plan ={"G11中转G24", '南京南', '10:33', '13:30', '2', '8', 1, train1, train4, 1, 2};
            testcase.verifyEqual(testcase.UserBackend.TrainUI.Find_num_available_ticket(single_plan),0);            
        end
    end
end