classdef ElevatorController < handle
    ...
    methods
                ...
                case 0
                    ...
                    elseif(control.elevator_2.position == floor && control.elevator_2.Alarm == 0)
                        ...
                        if (strcmp(control.elevator_1.direction, 'idle') && control.elevator_1.Alarm == 0)
                            if dis(control, 1, floor) <= dis(control, 2, floor)
                                control.elevator_1.setDestination(floor);
                            elseif control.elevator_2.Alarm == 1
                                control.elevator_1.setDestination(floor);
                            end
                        elseif (strcmp(control.elevator_2.direction, 'idle') && control.elevator_2.Alarm == 0)
                            if dis(control, 1, floor) >= dis(control, 2, floor)
                                control.elevator_2.setDestination(floor);
                            elseif control.elevator_1.Alarm == 1
                                control.elevator_2.setDestination(floor);
                            end
                        else
        ...
        function openDoorAtFloor(control, id, pos)
            ...
            switch id
                case 1
                    if control.elevator_1.speed == 0
                        control.elevator_1.state = control.elevator_1.state + control.openTime;
                        control.Back.State.Value = 'opening';
                        control.elevatorInUI_1.openDoor();
                        control.Back.State.Value = 'opened';
                        control.elevatorInUI_1.HumanEnterSensorButton.Enable = 'on';
                        control.elevatorInUI_1.OverWeightSensorButton.Enable = 'on';
                    end
                case 2
                    if control.elevator_2.speed == 0
                        control.elevator_2.state = control.elevator_2.state + control.openTime;
                        control.Back.State2.Value = 'opening';
                        control.elevatorInUI_2.openDoor();
                        control.Back.State2.Value = 'opened';
                        control.elevatorInUI_2.HumanEnterSensorButton.Enable = 'on';
                        control.elevatorInUI_2.OverWeightSensorButton.Enable = 'on';
                    end
            end
            ...
            switch id
                case 1
                    if control.elevator_1.Alarm == 0
                        ...
                        control.Back.State.Value = 'closing';
                        control.elevatorInUI_1.closeDoor();
                        control.Back.State.Value = 'closed';
                        control.elevatorInUI_1.HumanEnterSensorButton.Enable = 'off';
                        control.elevatorInUI_1.OverWeightSensorButton.Enable = 'off';
                    end
                case 2
                    if control.elevator_2.Alarm == 0
                        control.elevator_2.state = 0;
                        control.Back.State2.Value = 'closing';
                        control.elevatorInUI_2.closeDoor();
                        control.Back.State2.Value = 'closed';
                        control.elevatorInUI_2.HumanEnterSensorButton.Enable = 'off';
                        control.elevatorInUI_2.OverWeightSensorButton.Enable = 'off';
                    end
            end
        ...
        function updateOutUI(control, h1, h2)
            ...
            control.Back.FloorEditField.Value = fix(1 + h1/3);
            control.Back.FloorEditField_2.Value = fix(1 + h2/3);
            control.Back.SpeedEditField.Value = control.elevator_1.speed;
            control.Back.SpeedEditField_2.Value = control.elevator_2.speed;
