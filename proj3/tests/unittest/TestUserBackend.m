classdef TestUserBackend < matlab.unittest.TestCase
    properties
        UserBackend
    end
    ...
    methods(Test)
        % T1.4.1
        function test_table_manage(testcase)
            % T1.4.1.1
            train10 = train("D12",1,"上海虹桥","杭州东","10:03","11:00",{'上海虹桥','','10:03',2;'嘉兴南','10:30','10:33',2;'杭州东','11:00','',0});
            single_plan = {"D12", '无', '10:03', '11:00', '2', '2', 0, train10, 1, 3};
            testcase.UserBackend.table_manage(single_plan);
            testcase.verifyEqual(testcase.UserBackend.ticket_list.num_tickets,1);
            % T1.4.1.2
            train1 = train("G11",4,"上海虹桥","南京南","10:33","11:30",{'上海虹桥', '', '10:33',2; '南京南', '11:30', '',0});
            train4 = train("G24",4,"南京南","杭州东","12:33","13:30",{'南京南', '', '12:33',2; '杭州东', '13:30', '',0});
            single_plan ={"G11中转G24", '南京南', '10:33', '13:30', '2', '8', 1, train1, train4, 1, 2};
            testcase.UserBackend.table_manage(single_plan);
            testcase.verifyEqual(testcase.UserBackend.ticket_list.num_tickets,3);
        end
        %T1.4.2
        function test_table_manage_back(testcase)
            train10 = train("D12",1,"上海虹桥","杭州东","10:03","11:00",{'上海虹桥','','10:03',2;'嘉兴南','10:30','10:33',2;'杭州东','11:00','',0});
            single_plan1 = {"D12", '无', '10:03', '11:00', '2', '2', 0, train10, 1, 3};
            testcase.UserBackend.table_manage(single_plan1);
            train1 = train("G11",4,"上海虹桥","南京南","10:33","11:30",{'上海虹桥', '', '10:33',2; '南京南', '11:30', '',0});
            train4 = train("G24",4,"南京南","杭州东","12:33","13:30",{'南京南', '', '12:33',2; '杭州东', '13:30', '',0});
            single_plan2 ={"G11中转G24", '南京南', '10:33', '13:30', '2', '8', 1, train1, train4, 1, 2};
            testcase.UserBackend.table_manage(single_plan2);
            % T1.4.2.1
            testcase.verifyEqual(testcase.UserBackend.ticket_list.num_tickets,3);
            % T1.4.2.2
            testcase.UserBackend.table_manage_back(single_plan1);
            testcase.verifyEqual(testcase.UserBackend.ticket_list.num_tickets,2);
            % branch cover
        end
